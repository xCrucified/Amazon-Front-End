...
const AddAddressDialog = ({setIsOpen}: AddCardModalProps) => {
  ...
  return (
    <div className="fixed left-0 top-0 h-screen flex items-center justify-center bg-black bg-opacity-50 w-full">
      <div className="w-full max-w-[361px] md:max-w-[405px] bg-white rounded-xl shadow-lg px-4 md:px-8 py-4 md:py-8 relative max-h-[calc(100vh-30px)] overflow-y-scroll scrollbar">
        ...
        <Form {...form}>
          <form className="space-y-4" onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <FormField
              ...
              name="apt"
              render={({field}) => (
                <FormItem className="flex items-start flex-col min-w-[329px] md:min-w-[340px] mb-[32px]">
                  <FormControl>
            ...
            <FormField
              ...
              name="postalCode"
              render={({field}) => (
                <FormItem className="flex items-start flex-col min-w-[329px] md:min-w-[340px]">
