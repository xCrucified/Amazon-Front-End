  ...
  return (
    <div className="flex w-[1492px] h-[300px] gap-[68px] mx-auto pt-12">
      <section className="w-[812px] flex flex-col gap-4">
        <section className="flex flex-col w-full h-[fit-content] bg-[#f0f0f0] p-5 rounded-lg">
        ...
        <section className="w-full h-[fit-content] p-7 bg-[#f0f0f0] rounded-lg">
        ...
        <p className="text-[15px] leading-[16px] pb-4">
      ...
      <section className="w-[612px] h-full bg-[#f0f0f0] rounded-lg"></section>
    </div>
  );
}
