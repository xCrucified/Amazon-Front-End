...
const UserProfile = () => {
  const [isTwoStepVerificationEnabled, setTwoStepVerificationEnabled] = useState(false);
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <header className="bg-white shadow-sm">
        <div className="container mx-auto flex justify-between items-center py-4 px-6">
          ...
          <div className="flex items-center gap-6">
            ...
            />
            <button className="text-sm font-medium text-gray-600 hover:text-black">Cart</button>
            <button className="text-sm font-medium text-gray-600 hover:text-black">User Userovich</button>
          </div>
        </div>
      </header>
      ...
      <main className="container mx-auto py-8 px-6 grid grid-cols-1 lg:grid-cols-12 gap-6">
        {/* Sidebar */}
        <aside className="hidden lg:block col-span-3 bg-white rounded-lg shadow-sm">
            ...
            <div>
              <div className="flex justify-between">
                ...
                <div className="flex items-center gap-2">                 
                  <img src="/apple.svg" alt="Apple Logo" className="w-6 h-6 ml-3" />
              ...
              <p className="text-gray-500 mt-2 text-sm">
                Sign in the same way you unlock your device by using Face ID or Touch ID.
              </p>
            </div>
            {/* Password */}
            <div>
              <div className="flex justify-between">
                ...
                <div className="flex flex-col text-right">
                  ...
                  -600 hover:underline text-sm mt-2">Change password</a>
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-between items-center">
              ...
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  ...
                  onChange={() => setTwoStepVerificationEnabled(!isTwoStepVerificationEnabled)}
                />
